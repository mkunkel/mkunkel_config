...
[core]
s0_active_plugins = core;composite;opengl;compiztoolbox;maximumize;commands;widget;grid;wall;resize;move;vpswitch;copytex;snap;place;regex;imgpng;mousepoll;unitymtgrabhandles;session;animation;expo;ezoom;fade;workarounds;scale;unityshell;
...
s0_run_command_terminal_key = <Shift><Control><Alt>t
...
s0_put_left_key = <Shift><Control><Alt>Right
